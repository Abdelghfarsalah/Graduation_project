...
import 'package:graduation_project/feature/Authentication/presentation/widget/VerifyEmailcodeForResetPassbody.dart';
    ...
    return Scaffold(
        ...
        body: BlocConsumer<Resetpassbloc, Resetpassstate>(
          listener: (context, state) {
            print(state);
            if (state is forgetpasswordotpLoading) {
              loading = true;
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => Resetyourpasswordpage(
                    email: email,
                  ),
                ),
              );
          ...
          builder: (context, state) {
            return ModalProgressHUD(
              ...
              child: Verifyemailcodeforresetpassbody(
                Email: email,
              ),
            );
          },
